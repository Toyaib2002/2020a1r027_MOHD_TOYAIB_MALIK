...
statusbar = ttk.Label(root, text="Welcome to Dogra Music Player", anchor=W, font='Arial 8 italic')
statusbar.pack(side=BOTTOM, fill=X)
statusbar1 = ttk.Label(root, text="Welcome to Dogra Music Player", anchor=W, font='Arial 8 italic')
...
def play_music():
    ...
    if paused:
        ...
        try:
            ...
            tkinter.messagebox.showerror('File not found', 'Malik music player could not find the file. Please select again.')
def stop_music():
    mixer.music.stop()
